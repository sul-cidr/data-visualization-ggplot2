...
author: "Josh Quan"
date: "04 March 2020 <br><br> cidr.link/"
output:
...
ggplot(data = stops, aes(x = quarter, y = search_rate_100, color = driver_race)) +
  ...
  theme_minimal() +
  labs(x = "Year", y = "Search Rate", color = "Driver Race",
       title = "Washington stops", subtitle = "Number of stops before and after legalization")
```
...
* Play with themes and adjust titles, subtitles, captions, etc.*

* Bonus: Show Washington and Colorado side by side *
